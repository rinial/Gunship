...
#define EDGE_BITMASKS COLLISION_BITMASK_EDGE, COLLISION_BITMASK_ALL, COLLISION_BITMASK_NOTHING // self, hit, overlap
#define GUNSHIP_BITMASKS COLLISION_BITMASK_GUNSHIP, COLLISION_BITMASK_ASTEROID | COLLISION_BITMASK_EDGE, COLLISION_BITMASK_NOTHING // self, hit, overlap
